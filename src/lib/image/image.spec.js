...
describe('Img', () => {
    ...
    describe('on data loaded', () => {
        ...
        it('should have bytesUncompressed set', () => {
            expect(image.bytesUncompressed).toBe(size * size * IMAGE_COLOR_TYPE[image.type]);
        });
    });
    ...
    describe('getBytesVideo', () => {
        describe('gpuDataFull: false default', () => {
            ...
            it('should return byte for size', () => {
                const expected = size.width * size.height * IMAGE_COLOR_TYPE[image.type];
